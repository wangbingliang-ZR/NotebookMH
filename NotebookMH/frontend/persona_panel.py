...
def render() -> None:
    ...
    teacher_sel = st.sidebar.selectbox(
        "教师人格",
    ...
    emotion_sel = st.sidebar.selectbox(
        "当前情绪",
    ...
    st.sidebar.markdown(
        ...
        ">
            <span style="color:#00d4aa; font-weight:bold;">🧠 生效人格</span><br/>
            <span style="color:#e0e0e0; font-size:0.95rem;">{resolved_label}</span>
        </div>
        """,
